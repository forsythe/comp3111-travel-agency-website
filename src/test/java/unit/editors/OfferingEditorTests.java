...
public class OfferingEditorTests {
	...
	public void testCanSaveValidOffering() {
		...
		// Workaround: the date validator is not called for mockito objects, and
		// defaults to false. However, all other fields should have no error
		assertEquals(1, offeringEditor.getValidationStatus().getValidationErrors().size());
	}

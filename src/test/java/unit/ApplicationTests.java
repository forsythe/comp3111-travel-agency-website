...
public class ApplicationTests {
	...
	//
	// @Test
	// public void testSuccessCreateOfferingAndBookingForUnsavedEntities() throws
	// OfferingOutOfRoomException,
	// OfferingDateUnsupportedException, OfferingDayOfWeekUnsupportedException,
	...
	// Tour anonTour = new Tour("Shimen Forest", "Color ponds...", 2, 0.8, 0, 499,
	// 599);
	// anonTour.setAllowedDaysOfWeek(new
	// HashSet<Integer>(Arrays.asList(Calendar.MONDAY, Calendar.SUNDAY)));
	//
	...
	// new GregorianCalendar(2017, Calendar.DECEMBER, 4).getTime(), "Hotel chep", 4,
	// 20);
	// Booking anonBooking = actionManager.createBookingForOffering(anonOffering,
	// anonCust, 5, 2, 3, 0, "no smoking",
	...
	//
	// @Test
	// public void testSuccessCreateOfferingAndBookingForSavedEntities() throws
	// OfferingOutOfRoomException,
	// OfferingDateUnsupportedException, OfferingDayOfWeekUnsupportedException,
	// TourGuideUnavailableException {
	//
	...
	// new HashSet<Date>(Arrays.asList(new GregorianCalendar(2017,
	// Calendar.DECEMBER, 9).getTime(),
	// new GregorianCalendar(2017, Calendar.DECEMBER, 12).getTime())));
	//
	// tourRepo.save(tour1);
	//
	// Offering yangShanOffering =
	// actionManager.createOfferingForTour(tourRepo.findOne(tour1.getId()),
	// tourGuideRepo.findOne(tg1.getId()), new
	// ArrayList<Date>(tour1.getAllowedDates()).get(0), "hotel bob", 5,
	// 18);
	// Booking booking =
	// actionManager.createBookingForOffering(offeringRepo.findOne(yangShanOffering.getId()),
	// customerRepo.findOne(c1.getId()), 3, 4, 2, 0, "kids meal",
	...
	//
	// @Test
	// public void testSuccessTwoCustomersMakeBookingForATour() throws
	// OfferingDateUnsupportedException,
	...
	//
	// actionManager.createBookingForOffering(offeringRepo.findOne(yangShanOffering.getId()),
	// customerRepo.findOne(c2.getId()), 3, 4, 2, 0, "no smoking meal",
	// Booking.PAYMENT_PENDING);
	//
	// then(this.offeringRepo.findByHotelName(yangShanOffering.getHotelName()).size()).isEqualTo(1);
	...
	// 18);
	// Booking book1 =
	// actionManager.createBookingForOffering(offeringRepo.findOne(offering1.getId()),
	// customerRepo.findOne(c1.getId()), 3, 4, 2, 0, "kids meal",
	// Booking.PAYMENT_PENDING);
	//
	// Offering offering2 =
	// actionManager.createOfferingForTour(tourRepo.findOne(tour1.getId()),
	// tourGuideRepo.findOne(tg2.getId()), new
	// ArrayList<Date>(tour1.getAllowedDates()).get(0), "hotel cheap",
	// 5, 18);
	// Booking book2 =
	// actionManager.createBookingForOffering(offeringRepo.findOne(offering2.getId()),
	// customerRepo.findOne(c2.getId()), 3, 4, 2, 0, "kids meal",
	// Booking.PAYMENT_CONFIRMED);
	//
	...
	// public void testFailureCreateTwoOfferingsWithSameTourGuide() throws
	// OfferingDateUnsupportedException,
	// OfferingDayOfWeekUnsupportedException, TourGuideUnavailableException,
	// OfferingOutOfRoomException {
	//
	...
	//
	// actionManager.createOfferingForTour(tourRepo.findOne(tour1.getId()),
	// tourGuideRepo.findOne(tg1.getId()),
	...
	// public void testFailureTryToMakeOfferingForUnsupportedDate() throws
	// OfferingDateUnsupportedException,
	// OfferingDayOfWeekUnsupportedException, TourGuideUnavailableException {
	//
	// Tour yangshanTour = new Tour("Yangshan", "Many hotsprings", 3, 0.8, 0.0, 599,
	// 699);
	...
	//
	// actionManager.createOfferingForTour(tourRepo.findOne(yangshanTour.getId()),
	// tourGuideRepo.findOne(tg1.getId()),
	// new GregorianCalendar(2020, Calendar.DECEMBER, 12).getTime(), "hotel bob", 5,
	// 18);
	// }
	//
	// @Test(expected = OfferingDayOfWeekUnsupportedException.class)
	// public void testFailureTryToMakeOfferingForUnsupportedDayOfWeek() throws
	// OfferingOutOfRoomException,
	// OfferingDateUnsupportedException, OfferingDayOfWeekUnsupportedException,
	// TourGuideUnavailableException {
	//
	// Tour shimenTour = new Tour("Shimen Forest", "Color ponds...", 2, 0.8, 0, 499,
	// 599);
	// shimenTour.setAllowedDaysOfWeek(new
	// HashSet<Integer>(Arrays.asList(Calendar.TUESDAY, Calendar.SUNDAY)));
	//
	...
	// public void testFailureOfferingOutOfRoomWhenBooking() throws
	// OfferingDateUnsupportedException,
	// OfferingDayOfWeekUnsupportedException, TourGuideUnavailableException,
	// OfferingOutOfRoomException {
	//
	...
	// Offering shimenOffering = actionManager.createOfferingForTour(shimenTour,
	// tg1,
	// new GregorianCalendar(2017, Calendar.DECEMBER, 4).getTime(), "Hotel chep", 4,
	// offeringMaxSize);
	//
	...
	// customerRepo.findOne(c1.getId()), numAdults, numChildren, numToddlers, 0,
	// "kids meal",
	// Booking.PAYMENT_CONFIRMED);
	// }
